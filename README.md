...
## Project Overview
This project analyses child health, wellbeing, and school performance data collected from multiple sources including schools, clinics, and community programs.
...
## Key Analysis Areas
- Attendance rates and wellbeing outcomes
- Socioeconomic indicators and mental health
- Health checkup coverage
- Correlations between attendance, performance, and wellbeing
